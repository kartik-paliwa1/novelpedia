          ...
          <div className="p-6 w-full md:w-3/4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="neumorphic p-3 rounded-lg">
                ...
                <div className="text-sm font-medium">{selectedNovel.lastUpdated}</div>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <div className="text-xs text-muted-foreground">{selectedNovel.chapters}/25</div>
              </div>
              <div className="h-2 w-full bg-secondary rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-primary/80 to-primary"
                  style={{ width: `${selectedNovel.progress}%` }}
                ></div>
              </div>
            </div>
