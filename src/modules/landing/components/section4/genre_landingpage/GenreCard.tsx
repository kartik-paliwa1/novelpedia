'use client';
import FeaturedTopBook from '@/modules/landing/components/section4/genre_landingpage/FeaturedTopBook';
import GenreBookList from '@/modules/landing/components/section4/genre_landingpage/GenreBookList';
