          ...
          <div className="relative">
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <IconText icon={BookOpen}>{Number((data as any)?.chapters ?? 0)} chapters</IconText>
                <IconText icon={Eye}>{Number((data as any)?.views ?? 0).toLocaleString()}</IconText>
        ...
        <CardContent className="p-0">
          <div className="flex items-center gap-4 p-6">
            <div className="relative w-10 h-12 rounded-lg overflow-hidden">
              <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: data.cover ? `url(${data.cover})` : 'none' }} />
              {!data.cover && <div className="absolute inset-0 bg-gradient-to-br from-slate-700 to-slate-900" />}
            </div>
